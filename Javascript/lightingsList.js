const makeRequest = async () => {
  let response = await fetch("https://blooming-brook-91845.herokuapp.com/api/items/itemCategory?itemCategory=lighting");
...
const renderItems = async () => {
  ...
  let displayItem = document.getElementById("lightings_list");
